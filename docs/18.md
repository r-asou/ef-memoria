...
<img :src="$withBase('/hobby/61.jpg')" alt="foo">
...
<img :src="$withBase('/hobby/62.jpg')" alt="foo">
<img :src="$withBase('/hobby/63.jpg')" alt="foo">
...
<img :src="$withBase('/hobby/66.jpg')" alt="foo">
<img :src="$withBase('/hobby/67.jpg')" alt="foo">
...
<img :src="$withBase('/hobby/65.jpg')" alt="foo">
